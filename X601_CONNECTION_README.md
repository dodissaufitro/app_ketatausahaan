...
- `ip` (string, optional): IP address mesin X601. Default: `10.88.125.230`
...
```
GET /api/attendances/connect-x601?ip=10.88.125.230&key=0&tgl_awal=2024-01-01&tgl_akhir=2024-01-31
```
...
{
    "success": false,
    "error": "Connection failed: Unable to connect to 10.88.125.230",
    "parameters": {
        "ip": "10.88.125.230",
        "key": "0",
        "tgl_awal": "",
