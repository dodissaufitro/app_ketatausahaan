...
- **Masalah**: Sync endpoint tidak bisa override IP (fixed ke 10.88.125.230)
- **Solusi**:
    - `syncFromX601()` sekarang accept optional `ip`, `key`, `port` parameters
    - `fetchFromX601()` juga support parameter override
    - Default fallback ke 10.88.125.230 jika tidak provided
...
3. Set IP: 10.88.125.230, Port: 80, Key: 0 (or use defaults)
